...
@OnlyIn(Dist.CLIENT)
public class PCChooseCPUGuiWindow extends ContainerScreen<PCChooseCPUGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public PCChooseCPUGuiWindow(PCChooseCPUGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {

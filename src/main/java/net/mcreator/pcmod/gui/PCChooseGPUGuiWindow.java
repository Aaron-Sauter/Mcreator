...
@OnlyIn(Dist.CLIENT)
public class PCChooseGPUGuiWindow extends ContainerScreen<PCChooseGPUGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public PCChooseGPUGuiWindow(PCChooseGPUGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {

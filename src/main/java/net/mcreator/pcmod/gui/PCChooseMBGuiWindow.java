...
@OnlyIn(Dist.CLIENT)
public class PCChooseMBGuiWindow extends ContainerScreen<PCChooseMBGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public PCChooseMBGuiWindow(PCChooseMBGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {

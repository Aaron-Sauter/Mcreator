...
public class PCChooseProzessorGui extends PcmodModElements.ModElement {

	public static HashMap guistate = new HashMap();

	private static ContainerType<GuiContainerMod> containerType = null;

	public PCChooseProzessorGui(PcmodModElements instance) {
		super(instance, 16);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("pc_choose_prozessor"));
		}
	...
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, PCChooseProzessorGuiWindow::new));
	}

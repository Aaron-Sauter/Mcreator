...
public class CaseMainBoardCpuBlock extends PcmodModElements.ModElement {
	@ObjectHolder("pcmod:case_main_board_cpu")
	public static final Block block = null;
	public CaseMainBoardCpuBlock(PcmodModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("case_main_board_cpu");
		}

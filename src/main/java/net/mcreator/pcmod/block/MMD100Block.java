...
public class MMD100Block extends PcmodModElements.ModElement {
	@ObjectHolder("pcmod:mmd_100")
	public static final Block block = null;
	public MMD100Block(PcmodModElements instance) {
		super(instance, 4);
	}

...
public class TESTGPUBlock extends PcmodModElements.ModElement {
	@ObjectHolder("pcmod:testgpu")
	public static final Block block = null;
	public TESTGPUBlock(PcmodModElements instance) {
		super(instance, 19);
	}

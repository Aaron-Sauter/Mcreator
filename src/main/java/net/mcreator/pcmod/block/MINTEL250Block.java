...
public class MINTEL250Block extends PcmodModElements.ModElement {
	@ObjectHolder("pcmod:mintel_250")
	public static final Block block = null;
	public MINTEL250Block(PcmodModElements instance) {
		super(instance, 3);
	}
